    ...
    <section className="container mb-[64px]">
      ...
      <div className="flex text-[#333]/80 mt-12 flex-col gap-2">
        ...
        <p className="tracking-wide max-sm:text-sm">
          ჩვენ ვხედავთ ვებსაიტს, როგორც ნოუთს — ჩანაწერს, რომელიც არა მხოლოდ ინფორმაციას ინახავს,
          არამედ ქმნის სწორ ჰარმონიას მომხმარებელთან. თითოეული ნოტი — დიზაინი • SEO • AI — ერთად
          ქმნიან ციფრულ სიმფონიას — თქვენი ბრენდის ისტორიას სწორ ტონალობაში.
        </p>
        ...
        <p className="tracking-wide max-sm:text-sm">
          ...
          სტრატეგიული დაგეგმვიდან • დიზაინამდე • ფუნქციონალის ინტეგრაციამდე. თითეული პროექტი არის
          ინდივიდუალური, მორგებული თქვენი ბიზნესის მიზნებზე, რათა უზრუნველვყოთ გამორჩეული ციფრული
          გამოცდილება და რეალური შედეგები.
        </p>
        ...
        <p className="tracking-wide max-sm:text-sm">
          ვებსაიტებს ვამზადებთ ან WordPress-ის პლატფორმაზე, ან სრულად კოდით, თქვენი ბიუჯეტისა და
          საჭიროებების შესაბამისად. გარდა ამისა, ვებსაიტის კოდით დამზადების შემთხვევაში (და არა
          WordPress-ით) გთავაზობთ სრულიად უფასო თანამედროვე AI ტექნოლოგიის ინტეგრირებას. თქვენ იხდით
          მხოლოდ ვებსაიტის დამზადების საფასურს — AI არის ჩვენი საჩუქარი თქვენთვის! ეს შეიძლება იყოს
          პერსონალიზირებული ჩეთბოტი ან სხვა ფუნქციონალი, რომელიც თქვენს ვებსაიტს უფრო ინოვაციურსა და
          ეფექტურს გახდის.
        </p>
      </div>
    </section>
